...
public enum PixelModelEnum {
    ...
    PIXEL_V1("Pixel 1.0", IdeogramModelEnum.V_1_TURBO, IdeogramModelEnum.V_1),
    PIXEL_V2("Pixel 2.0", IdeogramModelEnum.V_2_TURBO, IdeogramModelEnum.V_2),
    PIXEL_V2A("Pixel 3.0", IdeogramModelEnum.V_2A_TURBO, IdeogramModelEnum.V_2A);
